...
plot(st_geometry(pa_sf), col = "#aaaaaa", border = NA, add = TRUE)
```

<br />

If you have problems, please open issues at:[https://github.com/frbcesab/worldpa/issues](https://github.com/frbcesab/worldpa/issues)
