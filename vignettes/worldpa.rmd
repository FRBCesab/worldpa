...
It allows user to download spatial shapefiles of protected areas (PA) for world countries using WDPA API ([https://api.protectedplanet.net](https://api.protectedplanet.net)).
...
- [`get_countries()`](https://frbcesab.github.io/worldpa/reference/get_countries.html): get the world countries names and ISO-3 code (informations also available in the internal dataset `wdpa_countries`);
...
Use the function `usethis::edit_r_environ()` to open this file and add this line (by replacing z999zzz... by your Personal WDPA API Token):
...
# Getting countries informations
