...
#' ## First 10 features:
#' ##    wdpa_id           pa_name country_iso3 is_marine           designation iucn_category                           geom
#' ## 1     1652           Borjomi          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((43.392 41.9...
#' ## 2     1653         Lagodekhi          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((46.27 41.89...
#' ## 3     1654             Ritsa          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((40.596 43.4...
#' ## 4     1656         Kintrishi          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((41.996 41.7...
#' ## 5     1657           Liakhvi          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((44.331 42.3...
#' ## 6     1660        Vashlovani          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((46.623 41.1...
#' ## 7     1664 Bichvinta-Miusera          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((40.5 43.151...
#' ## 8     1665       Mariamjvari          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((45.364 41.7...
#' ## 9     1666          Kolkheti          GEO      TRUE         National Park            II MULTIPOLYGON (((41.754 42.0...
#' ## 10    1667          Sataplia          GEO     FALSE Strict Nature Reserve            Ia MULTIPOLYGON (((42.677 42.3...
